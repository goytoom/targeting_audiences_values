...
# Extract -----------------------------------------------------------------
  ...
  write_rds(draws, "../mediations/mediation_replication_effects.rds")
...
########## Alternative Model (M2)  
  ...
  write_rds(draws, "../mediations/mediation_RT_effects.rds")
...
########### Main Model (M3)
  ...
  write_rds(draws, "../mediations/mediation_del_effects.rds")
