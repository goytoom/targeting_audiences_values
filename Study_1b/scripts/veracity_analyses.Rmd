---
title: "Additional Analyses (Veracity) - Study 1b"
...
## Fit Models
```{r}
## "Full" Models: M1 and M2 with added moral alignment
# Model 1 (Headline-Level Predictors)
m1_fit_full <- brm(
 z_post_share_index ~ 1 + z_kk_headline_believable + z_kk_headline_controversial + z_kk_headline_surprising + z_kk_headline_interesting + z_kk_headline_positive + z_kk_headline_true + z_headline_believable + z_headline_controversial + z_headline_surprising + z_headline_interesting + z_headline_positive + x_post_framing*(z_jj_mfq_indi+z_jj_mfq_bind+z_jj_mfq_prop) + (1|ii) + (1|jj) + (1 + z_headline_believable + z_headline_controversial + z_headline_surprising + z_headline_interesting + z_headline_positive + x_post_framing*(z_jj_mfq_indi+z_jj_mfq_bind+z_jj_mfq_prop)|kk),
 data = df,
 chains = 8,
 iter = 1000,
warmup = 750,
...
## Add veracity interactions to model M6
m6_fit_ver <- brm(
...
print(bayes_R2(m1_fit))
print(bayes_R2(m1_fit_full))
print(noquote(""))

print("M2-Post: Original vs Veracity interaction")
print(bayes_R2(m2_fit))
print(bayes_R2(m2_fit_full))
print(noquote(""))
```
...
m6_results <- m6_fit_ver %>% 
    ...
    transmute(
      ...
      # d_indi_indi_bind_true_false = d_indi_indi_bind - d_indi_indi_bind_true,
      # d_indi_indi_nonm_true_false = d_indi_indi_nonm - d_indi_indi_nonm_true,
      # d_indi_bind_nonm_true_false = d_indi_bind_nonm - d_indi_bind_nonm_true,
      # d_bind_bind_indi_true_false = d_bind_bind_indi - d_bind_bind_indi_true,
      # d_bind_bind_nonm_true_false = d_bind_bind_nonm - d_bind_bind_nonm_true,
      # d_bind_ind_nonm_true_false = d_bind_ind_nonm - d_bind_ind_nonm_true,
