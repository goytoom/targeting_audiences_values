...
create datasets based on aggregate mode (moral/nonmoral, binding/individualizing, all foundations)
    Determine annotations based on individual annotator ratings
